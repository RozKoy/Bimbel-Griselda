...
const CardProgram: React.FC<CardProgramProps> = ({
  ...
  return (
    <div className=" relative flex items-end justify-center sm:h-[400px]  sm:w-[320px]">
      ...
      <div className="rounded-full  bg-[#FFB907] shadow-[5px_5px_4px_0px] shadow-[#00000040] flex justify-center items-center absolute top-0 left-0 sm:w-[100px] sm:h-[100px]">
