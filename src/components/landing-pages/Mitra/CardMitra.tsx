...
const CardMitra: React.FC<CardMitraProps> = ({ title, description, src }) => {
  return (
    <div className="flex flex-col justify-end items-end relative w-[325.56px] h-[193px]   my-0 sm:my-10 sm:w-[360px] sm:h-[235px] ">
      <div className="rounded-[20px] bg-gradient-to-b from-blue-600 to-blue-400 shadow-md flex flex-col space-y-2 w-[315.56px] h-[160.19px] pl-3 pt-3  sm:w-[350px] sm:h-[205px] sm:pt-2 sm:pl-6">
        <p className="font-bold text-[18px] ml-16 sm:text-2xl sm:ml-16 ">
          {title}
        </p>
        <p className="text-[11px] sm:text-xs">{description}</p>
      </div>
