...
const CardServices: React.FC<CardServicesProps> = ({ title, description }) => {
  return (
    <div className="bg-white rounded-t-[28px] rounded-b-[8px] hover:shadow-[0px_2.796px_27.956px_0px] hover:shadow-[#0065FF] cursor-pointer flex flex-col space-y-6 items-center sm:py-8 sm:px-2">
